...
?>
<div <?php echo get_block_wrapper_attributes(array('class' => ($style_compact) ? 'compact-card' : '')); ?>>
        ...
        <div class="category-grid__container">
            ...
            ?>
                <div class="category-card__outer is-card-size-<?php echo $card_size ?>">
                    <div class="category-card__container lazyload" style=<?php echo $category_background ?> data-bgset="<?php echo esc_url( $bg_url ); ?>">
